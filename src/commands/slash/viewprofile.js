	...
	async run(interaction) {
		...
		const profileEmbed = new EmbedBuilder()
			...
			.addFields(
				{
					name: 'Bio',
					value: userProfile.bio || 'Not set',
					inline: true,
				},
				{
					name: 'Timezone',
					value: userProfile.timezone || 'Not set',
					inline: true,
				},
				{
					name: 'Active Hours',
					value: userProfile.activeHours || 'Not set',
					inline: true,
				},
				{
					name: 'Portfolio',
					value: userProfile.portfolio ? userProfile.portfolio : 'Not set',
					inline: true,
				},
				{
